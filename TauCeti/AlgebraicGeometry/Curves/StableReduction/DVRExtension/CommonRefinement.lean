...
theorem nonempty_binaryCofan_of_isGalois (N : Type u) [Field N] [Algebra K N]
  ...
  have hQ₁F : Q₁.comap (((σ : N →ₐ[K] N).comp k₂).restrictScalars R).mapIntegralClosure =
      F.prime := by
    rw [AlgHom.restrictScalars_comp, Ideal.comap_mapIntegralClosure_comp, hσ', hQ₂F]
  ...
  · rw [AlgHom.restrictScalars_comp, Ideal.comap_mapIntegralClosure_comp, he, hQ₁E]
  · rw [AlgHom.restrictScalars_comp, Ideal.comap_mapIntegralClosure_comp, he, hQ₁F]
