...
generating types induces a surjection of free pro-`p` groups, and that a topologically finitely
generated pro-`p` group is a continuous image of the free pro-`p` group on any finite type with at
least `topologicalGeneratorRankNat` elements.
