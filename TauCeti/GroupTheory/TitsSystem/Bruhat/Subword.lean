...
* `TauCeti.TitsSystem.subset_bruhatCell_mul_of_mem_simple` and
  `TauCeti.TitsSystem.bruhatCell_mul_subset_union_of_mem_simple`, with their `_right` variants:
  the adjacent cell always occurs in the product with a simple cell, and nothing beyond the
  adjacent and the original cell does.
